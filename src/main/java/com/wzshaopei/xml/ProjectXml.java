package com.wzshaopei.xml;

import com.wzshaopei.xml.model.builders.HudsonAnt;
import com.wzshaopei.xml.model.builders.HudsonGradle;
import com.wzshaopei.xml.model.scm.HudsonGit;
import com.wzshaopei.xml.model.scm.ProjectScm;
import com.wzshaopei.xml.model.scm.svn.HudsonSub;
import com.wzshaopei.xml.root.Maven;
import com.wzshaopei.xml.root.Project;
...
public class ProjectXml {
     ...
     */
    public static String getProjectXml() throws JAXBException, IllegalAccessException, InstantiationException, ClassNotFoundException {
        Class project = Project.class;
        String projectName = project.getName();
        Object root = ProjectXml.getRoot(projectName);
    ...
    private static ProjectScm getScm(Project project) {
     ...
     * @throws InstantiationException
     */
    static Object getRoot(String className) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
